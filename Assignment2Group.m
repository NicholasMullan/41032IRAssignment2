...
% Place fence
fence1XYZ = [0,0,fh];
%call the Place Object function to place fence
PlaceObject('fence.ply',fence1XYZ)

% Place fence
fence2XYZ = [-1,0,fh];
%call the Place Object function to place fence
PlaceObject('fence.ply',fence2XYZ)

%Place Fire Extinguisher
fireXYZ = [-2.9,2.9,fh+0.5];
%Placing fire extingisher
PlaceObject ('fireExtinguisherElevated.ply',fireXYZ)
